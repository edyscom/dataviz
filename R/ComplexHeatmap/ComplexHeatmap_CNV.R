...
palletSet3 <- colorRampPalette(palletSet3)(length(levels(rawdata$Chromosome)))
   ...
   # plot the pie chart
   png("CNV_plot.test.png", units="in", family="Times",  width=6, height=6, res=300, pointsize = 9) #pointsize is font size| increase image size to see the key
   ...
   Heatmap(zzz, 
		   ...
		   col = colorRamp2(c(0, 1, 10), c("green", "white", "red")),

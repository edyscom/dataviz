...
frac.table = matrix(
					c(100, 90, 00, 00,
					  ...
					  60, 0, 30, 20),
					  #98, 00, 95, 40),
					ncol=length(timepoints),byrow=F)
frac.table


### parent = max. VAF mutation. (child is depicted inside of parent)
### parent must be earlier entry than child  
parents = c(0,1,1,1)
#parents = c(0,1,1,3)
#parents = c(0,1,3,3)
...
fishPlot(fish,shape="spline",title.btm="633734", ### title (bottom)
